...
class ImageFolder(Dataset):
    ...
    """
    def __init__(self, root, transform=None,patch_size=(256,256), split='train',need_file_name = False,root2="",need_root2=False): #扩展root2 第二组数据集
    ...
    def __getitem__(self, index):
        ...
        if self.need_root2:
            ...
            img1_root2 = img1_root2[startH:(startH + self.patch_size[0]), startW:(startW + self.patch_size[1])]
            img2_root2 = img2_root2[startH:(startH + self.patch_size[0]), startW:(startW + self.patch_size[1])]
