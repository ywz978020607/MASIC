# real: udh-ft
# python test2_real_save_opencv.py -d "/home/yangwenzhe/database/sPekingmini2"  --seed 2  --test-patch-size 640 1088 --batch-size 1 --test-batch-size 1  --save --lambda 0.01
