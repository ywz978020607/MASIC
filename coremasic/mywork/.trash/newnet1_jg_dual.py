...
##z1_up+y2 for y1 gmm _same_resolution --dual
...
class HSIC(CompressionModel):
    ...
    def forward(self,x1,x2,h_matrix):
        ...
        gmm1_jg = self._h_s1_same_resolution(torch.cat((params1, ctx_params1,ctx_params2), dim=1)) #通道数 4M
        ###
