...
# python newtrain2_for_parrel_jgf2.py -d "/home/yangwenzhe/database/aftercut512"  --seed 0 --cuda 0 --patch-size 512 512 --batch-size 1 --test-batch-size 1  --save

#net defination
from newnet1_parrel_codec_jgf2 import *
