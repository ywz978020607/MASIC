...
#python newtrain2_real.py -d "/home/ywz/database/aftercut512"  --seed 0 --cuda 0 --patch-size 512 512 --batch-size 1 --test-batch-size 1  --save --lambda 0.01
...
def train_epoch(epoch, train_dataloader,modelhomo, model, criterion, optimizer,
    ...
    for i, d in enumerate(train_dataloader):
        ...
        # # debug
        # print(homo_img1.shape)
        # print(homo_img2.shape)
        # print(homo_corners0.shape)
