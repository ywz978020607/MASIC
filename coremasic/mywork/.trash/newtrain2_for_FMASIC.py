...
# python newtrain2_for_FMASIC.py -d "/home/yangwenzhe/database/aftercut512"  --seed 0 --cuda 0 --patch-size 512 512 --batch-size 1 --test-batch-size 1  --save --lambda 0.01 -e 800
# python newtrain2_for_FMASIC.py -d "/home/yangwenzhe/database/aftercut512" -da "/home/yangwenzhe/database/flickr"  --seed 0 --cuda 2 --patch-size 512 512 --test-patch-size 960 640 --batch-size 1 --test-batch-size 1   --save --lambda 0.025 -e 800
#
#net defination
from FMASIC import *
