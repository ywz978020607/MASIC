# newtrain2.py: 添加自动调整lambda功能. lambda_k = 0.282--暂未使用  直接加到loss中
# 单gpu版  # --learning-rate 5e-5  1e-4 # --lambda 0.001
# python newtrain2_for_jg.py -d "/home/yangwenzhe/database/aftercut512"  --seed 0 --cuda 0 --patch-size 512 512 --batch-size 1 --test-batch-size 1  --save

#net defination
from newnet1_jg_codec import *
