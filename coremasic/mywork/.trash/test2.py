...
#python test2.py -d "/home/yangwenzhe/database/aftercut512"  --seed 0 --cuda 0 --patch-size 512 512 --batch-size 1 --test-batch-size 1
#python test2.py -d "/home/yangwenzhe/database/flickr"  --seed 0 --cuda 0 --patch-size 960 640 --batch-size 1 --test-batch-size 1
#cpu版
