...
# python INEN_train1.py -d "/home/ywz/database/aftercut512_cvprplus_lambda_0.025" -d2 "/home/ywz/database/aftercut512"  --seed 0 --cuda 0 --patch-size 512 512 --batch-size 3 --test-batch-size 1  --save
