...
# python newtrain2_for_jg_gf_black4.py -d "/home/yangwenzhe/database/aftercut512"  --seed 0  --patch-size 512 512 --batch-size 3 --test-batch-size 1  --save --cuda 0
# python newtrain2_for_jg_gf_black4.py -d "/home/yangwenzhe/database/aftercut512" -da "/home/yangwenzhe/database/flickr"  --seed 0 --cuda 2 --patch-size 512 512 --batch-size 1 --test-batch-size 1   --save --lambda 0.025 -e 800
#
#net defination
from MASIC import *
