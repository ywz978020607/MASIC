...
#python test2_real.py -d "/home/yangwenzhe/database/sPeking"  --seed 0  --patch-size 1216 2176 --batch-size 1 --test-batch-size 1 --cuda 1 --homopath "homo_peking.pth.tar"
