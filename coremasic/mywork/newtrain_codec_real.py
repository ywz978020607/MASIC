...
#python newtrain_codec_real.py -d "/home/ywz/database/sPeking_8"  --seed 0 --cuda 0 --patch-size 512 512 --test-patch-size 1216 1664 --batch-size 3 --test-batch-size 1  --save --lambda 0.01 --homopath "homo_best_sPeking_8.pth.tar"
...
#python newtrain_codec_real.py -d "/home/ywz/database/aftercut512"  --seed 0 --cuda 0 --patch-size 512 512 --test-patch-size 512 512 --batch-size 3 --test-batch-size 1  --save --lambda 0.001 -e 200 --homopath "homo_best.pth.tar"
#python newtrain_codec_real.py -d "/home/ywz/database/aftercut512"  --seed 0  --patch-size 64 64 --test-patch-size 64 64 --batch-size 1 --test-batch-size 1  --cuda 0
#net defination
from MASIC import *
...
def main(argv):
    ...
    #加载最新模型继续训练
    # 加载最新模型继续训练
    print("intput homopath:",args.homopath)
    ...
    if os.path.exists("checkpoint_best_loss.pth.tar"):
        ...
        # pretrained_dict = {k: v for k, v in model['state_dict'].items() if (k in new_dict and "coder" not in str(k))}#filter out unnecessary keys
    ...
    print("autobest:")
    print(args.autobest)
    if homoload and modelload and args.autobest == 0:
        loss = test_epoch(-1, test_dataloader,nethomo, net, criterion)
    else:
        print("set best loss")
        loss = best_loss
