...
def main(argv):
    ...
    if os.path.exists("checkpoint_best_loss.pth.tar"):
        ...
        pretrained_dict = {k: v for k, v in model['state_dict'].items() if (k in new_dict and "gmm" not in str(k))}#filter out unnecessary keys
