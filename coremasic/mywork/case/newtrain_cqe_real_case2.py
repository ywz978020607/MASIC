...
#python newtrain6_real.py -d "/home/yangwenzhe/database/aftercut512_30"  --seed 0 --cuda 0 --patch-size 512 512 --batch-size 4 --test-batch-size 1  --save --lambda 0.025 -e 20
#python newtrain6_real.py -d "/home/yangwenzhe/database/KITTI2"  --seed 0 --cuda 0 --patch-size 320 1216 --batch-size 3 --test-batch-size 1  --save --lambda 0.025 -e 20
#python newtrain6_real.py -d "/home/yangwenzhe/database/flickr"  --seed 0 --cuda 0 --patch-size 960 640 --batch-size 1 --test-batch-size 1  --save --lambda 0.025 -e 20

#net defination
from MASIC_case2 import *
...
def main(argv):
    ...
    if os.path.exists("second_checkpoint_best_loss.pth.tar"):
        ...
        # 弱加载
        new_dict = net2.state_dict()
        # pretrained_dict = {k: v for k, v in model['state_dict'].items() if (k in new_dict)}#filter out unnecessary keys
        pretrained_dict = {k: v for k, v in model['state_dict'].items() if (k in new_dict and "attn_" not in str(k))}#filter out unnecessary keys
    ...
    best_loss = 1e10
    loss = test_epoch(-1, test_dataloader, nethomo,net,net2, criterion)
